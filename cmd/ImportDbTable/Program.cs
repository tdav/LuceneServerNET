    ...
    class Program
    {
        async static Task<int> Main(string[] args)
        {
            try
            {
                ...
                if (String.IsNullOrEmpty(serverUrl) || String.IsNullOrEmpty(indexName) || dbType == DbTypes.Unknown || String.IsNullOrEmpty(connectionString) || String.IsNullOrEmpty(sqlStatement) || fields.Count == 0)
                {
                ...
                //serverUrl = "http://localhost:15000";
                //indexName = "text_model";
                //dbType = DbTypes.Oracle;
                //connectionString = "Data Source=192.168.0.233/UCETMVD;User ID=texp;Password=uzb;";
                //sqlStatement = "SELECT sm.SP_ID AS ID, sm.SP_NAME as NAME FROM TEXP.ST_MODEL sm";
                //fields.Add("id", "{{ID}}");
